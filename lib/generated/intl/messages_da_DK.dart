...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(seconds) => "${seconds}sekunder siden";

  static String m20(msg) => "\n ${msg}Upload mislykkedes";

  static String m21(count) => "${count}Stemmer i alt";

  static String m22(count) => "${count}person, der holdes fanget for løsepenge";

  static String m23(index) => "${index}Valgmuligheder";

  static String m24(index) => "${index}Indstillingen kan ikke være tom";
