...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(seconds) => "${seconds}seconden geleden";

  static String m20(msg) => "\n ${msg}Uploaden mislukt";

  static String m21(count) => "${count}Totaal aantal stemmen";

  static String m22(count) => "${count}persoon vastgehouden voor losgeld";

  static String m23(index) => "${index}Opties";

  static String m24(index) => "${index}De optie kan niet leeg zijn";

  static String m25(datetime) => "${datetime}termijn na voltooiing";

  static String m26(name) =>
      "Are you sure that you want to cancel your follow request to ${name}?";

  static String m27(years) => "${years}...jaren geleden";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "clipCreate": MessageLookupByLibrary.simpleMessage("Nieuwe plakbriefjes"),
    ...
    "clipRemove": MessageLookupByLibrary.simpleMessage(
      "Kleefnotities verwijderen",
    ),
    "clipUpdate": MessageLookupByLibrary.simpleMessage(
      "Sticky Notes bijwerken",
    ),
    ...
    "exportEntityFavorite": MessageLookupByLibrary.simpleMessage(
      "Toevoegen aan favorieten",
    ),
    "exportEntityFollowing": MessageLookupByLibrary.simpleMessage("Volgend"),
    "exportEntityMuting": MessageLookupByLibrary.simpleMessage(
      "Gedempte gebruikers",
    ),
    "exportEntityNote": MessageLookupByLibrary.simpleMessage("Notities"),
    "exportEntityUserList": MessageLookupByLibrary.simpleMessage("Lijsten"),
    "favorite": MessageLookupByLibrary.simpleMessage("bladwijzer (internet)"),
    ...
    "loginLoading": m12,
    "loginSuccess": MessageLookupByLibrary.simpleMessage("Inloggen succesvol"),
    "manageAccount": MessageLookupByLibrary.simpleMessage("Account beheren"),
    "markAsSensitive": MessageLookupByLibrary.simpleMessage(
      "Markeer als gevoelige inhoud",
    ),
    "mention": MessageLookupByLibrary.simpleMessage("opvoeden (een onderwerp)"),
    ...
    "noteReNoteByUser": MessageLookupByLibrary.simpleMessage("Doorgestuurd."),
    ...
    "noteVisibilityHome": MessageLookupByLibrary.simpleMessage("afb. begin"),
    "noteVisibilityHomeText": MessageLookupByLibrary.simpleMessage(
      "Tijdlijn alleen naar startpagina gestuurd",
    ),
    "noteVisibilityPublic": MessageLookupByLibrary.simpleMessage("openlijk"),
    ...
    "notifyAccept": MessageLookupByLibrary.simpleMessage("Accepteren"),
    ...
    "notifyMentionedYou": MessageLookupByLibrary.simpleMessage("Vermelding"),
    "notifyMessage": MessageLookupByLibrary.simpleMessage("persoonlijke brief"),
    ...
    "notifyQuoted": MessageLookupByLibrary.simpleMessage("Quote"),
    "notifyReacted": MessageLookupByLibrary.simpleMessage("Reacties"),
    "notifyReactionGrouped": m17,
    "notifyReceiveFollowRequest": MessageLookupByLibrary.simpleMessage(
      "Requested to follow you",
    ),
    "notifyReject": MessageLookupByLibrary.simpleMessage("Weigeren"),
    "notifyRejected": MessageLookupByLibrary.simpleMessage("Weigeren"),
    "notifyRenoteGrouped": m18,
    "notifyRenoted": MessageLookupByLibrary.simpleMessage("Herdelen"),
    ...
    "previewNote": MessageLookupByLibrary.simpleMessage("Voorbeeld Berichten"),
    ...
    "reNoteHint": MessageLookupByLibrary.simpleMessage("Deze post citeren..."),
    ...
    "reactionAccepting": MessageLookupByLibrary.simpleMessage(
      "Emoji-reacties accepteren",
    ),
    "reactionAcceptingAll": MessageLookupByLibrary.simpleMessage("volledig"),
    ...
    "recipient": MessageLookupByLibrary.simpleMessage("Aan: (koptekst e-mail)"),
    "refresh": MessageLookupByLibrary.simpleMessage(
      "verversen (computervenster)",
    ),
    ...
    "renameFolder": MessageLookupByLibrary.simpleMessage("Een map hernoemen"),
    ...
    "saveSuccess": MessageLookupByLibrary.simpleMessage("Succesvol opslaan"),
    "search": MessageLookupByLibrary.simpleMessage("iets verwachten"),
    "searchAll": MessageLookupByLibrary.simpleMessage("volledig"),
    "searchHost": MessageLookupByLibrary.simpleMessage("Domeinnaam opgeven"),
    ...
    "selectUser": MessageLookupByLibrary.simpleMessage("Gebruiker selecteren"),
    ...
    "showConversation": MessageLookupByLibrary.simpleMessage("Bekijk dialoog"),
    ...
    "userRegisterBy": MessageLookupByLibrary.simpleMessage("ingeschreven in"),
